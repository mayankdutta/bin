...
output=$(g++ --std=c++20 -Wall -Wextra -Wformat=2 -Wfloat-equal -Wshift-overflow=2 -Wduplicated-cond -Wshadow -Wconversion -fsanitize=undefined -fsanitize=address $PROG_NAME 2>&1)
if [[ $? != 0 ]]; then
